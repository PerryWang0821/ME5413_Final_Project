...
class ImprovedTemplateMatcher:
    def __init__(self):
        ...
        self.scales = [0.5, 0.75, 1.0, 1.25, 1.5]  # Scales for template matching
    ...
    def transform_pose_to_map_frame(self, pose_stamped, from_frame, to_frame):
        try:
            self.tf_listener.waitForTransform(to_frame, from_frame, self.current_time, rospy.Duration(1.0))
